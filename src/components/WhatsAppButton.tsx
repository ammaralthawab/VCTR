...
const WA_NUMBER = "96655754 6130".replace(/\s/g, ""); // → 966557546130
    ...
    return (
        <>
            ...
            >
                ...
                <span className="whatsapp-pulse whatsapp-pulse--delay" aria-hidden />
            </a>
            ...
            <style>{`
                ...
                .whatsapp-fab:hover {
                    transform: scale(1.1);
                    box-shadow: 0 8px 36px rgba(37, 211, 102, 0.6), 0 4px 12px rgba(0,0,0,0.3);
                }
                .whatsapp-pulse {
                    position: absolute;
                    inset: 0;
